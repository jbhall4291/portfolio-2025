...
export default function IconTile({
    ...
    const baseClass =
        ...
        `transition-colors will-change-transform transform-gpu duration-300 p-[var(--pad)] lg:p-[var(--pad-lg)] ` +
    ...
    if (mount === "pop") {
        return (
            <motion.div
                ...
                style={style}
            >
                <img src={src} alt={alt} decoding="async" className="block w-full h-full" />
            </motion.div>
        );
    }
